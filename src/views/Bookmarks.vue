<template>
  <div>
    ...
    <div v-else-if="bookmarks.length === 0" class="alert alert-info">
      No bookmarks yet. Start bookmarking news items from the home page!
    </div>
    <div v-else class="row">
      <div v-for="item in filteredBookmarks" :key="item.guid" class="col-md-4 mb-4">
